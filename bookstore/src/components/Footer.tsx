    ...
    <footer className="bg-[#F3F2EC] text-gray-800 py-12">
      <div className="container mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          {/* Brand Section */}
          <div>
            <h2 className="text-3xl font-bold tracking-wide">BOOK<span className="text-gray-600">HIVE</span></h2>
            <p className="mt-4 text-gray-600">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sagittis sed ptibus liberolectus nonet psryroin. Amet sed lorem posuere sit iaculis amet, ac urna.
            </p>
          </div>
